...
typedef CX_StatusCode (* CX_SB_UTFConv_UTF8toUTF16_Func)(void *pContext, const CX_Char *szUTF8, CX_Size cUTF8Len,
...
typedef CX_StatusCode (* CX_SB_UTFConv_UTF16toUTF8_Func)(void *pContext, const CX_WChar *wszUTF16, CX_Size cUTF16Len,
